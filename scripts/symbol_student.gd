...
func _init():
	...
	localized_names = {}
	value = 1
	description = "Transforms into <icon_robin_hood> <icon_beastmaster> <icon_chef> <icon_dame> <icon_diver> <icon_farmer> <icon_archaeologist> <icon_mrs_fruit> <icon_witch> <icon_antiques_curator> <icon_bartender> <icon_card_shark> <icon_comedian> <icon_engineer> or <icon_joker> after giving <icon_coin> <text_color_keyword><value_1> times<end>."
