...
func _init():
	...
	localized_names = {}
	description = "Gives <icon_coin><color_FBF236><value_1><end> for each <icon_adoption_papers> <icon_tax_evasion> <icon_treasure_map> <icon_wanted_poster> <icon_zaroffs_contract> <icon_anthropology_degree> <icon_devils_deal> and <icon_old_photograph> you have atleast <color_E14A68>1<end> of."
